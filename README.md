...
Ghi chú học tập theo **chuỗi có thứ tự** — lý thuyết AI, kiến trúc mô hình, và tối ưu inference.
...
|---|---|---|
| **[Theory AI](https://dythanh22.github.io/bai-hoc/theory-ai/)** | Xác suất → thống kê → đại số tuyến tính → features / classical ML → activations, optimizers, DL → CV / NLP / RL / time series / recommender → MLOps | 15 chapter · ~187 bài ngắn |
...
Render whitelist (trong `_quarto.yml`): chỉ publish `index`, `about`, `404`, và ba chuỗi trên. Thư mục như `du-an/`, `nghien-cuu/` bị loại.
...
series: theory-ai          # hoặc architecture-models | ai-optimize
categories: [theory-ai, …]
```

Architecture Models thường thêm `role` (cột “Vai trò” trên bảng lộ trình). Theory / Optimize có thể thêm `group` theo chapter.
...
- File ghi chú nội bộ (`check-ui-2.md`, `theory-ai-integration-plan.md`, …) nằm trong `.gitignore` — không đưa lên Pages.
...
- Repo: [dythanh22/dythanh22.github.io](https://github.com/dythanh22/dythanh22.github.io)
