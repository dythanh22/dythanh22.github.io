...
group: "DDPM"
role: "x_T → ⋯ → x_0"
description: "Sampling: lặp reverse từ noise thuần đến mẫu sạch."
aliases:
  - /bai-hoc/architecture-models/Denoising-Diffusion-Probabilistic-Models/5-DDPM_Sampling.md
  - /bai-hoc/architecture-models/Denoising-Diffusion-Probabilistic-Models/5-DDPM_Sampling.html
---
