...
## Kiểm tra nhanh
<details>
<summary>Ý chính của bài «Warmup + Linear Decay LR Schedule» là gì?</summary>
Ngay lúc bắt đầu huấn luyện, mọi thứ đều ngẫu nhiên: * **Trọng số ngẫu nhiên**: khởi tạo từ một phân phối ngẫu nhiên (Xavier, He, v.v.) * **Activation ngẫu nhiên**: vì đầu vào đi qua trọng số ngẫu nhiên, activation về cơ bản là nhiễu * **Gradient không tin…
</details>
<details>
