...
## Kiểm tra nhanh
<details>
<summary>Ý chính của bài «AdaGrad Optimizer» là gì?</summary>
Hạ gradient thuần dùng một learning rate cho mọi tham số trong mô hình: Mọi trọng số, mọi bias, mọi phần tử embedding đều nhân với cùng $\eta$.
</details>
<details>
