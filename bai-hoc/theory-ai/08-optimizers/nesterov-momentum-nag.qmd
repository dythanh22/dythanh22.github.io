...
## Kiểm tra nhanh
<details>
<summary>Ý chính của bài «Nesterov Momentum (NAG)» là gì?</summary>
Hạ gradient thuần cập nhật tham số chỉ bằng gradient hiện tại: Cách này có vài vấn đề: * **Gradient nhiễu**: mỗi mini-batch cho một ước lượng gradient hơi khác.
</details>
<details>
