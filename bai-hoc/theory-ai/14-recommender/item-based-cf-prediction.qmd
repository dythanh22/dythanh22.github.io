...
## Kiểm tra nhanh
<details>
<summary>Ý chính của bài «Item-Based CF Prediction» là gì?</summary>
**Item-based collaborative filtering** dự đoán rating của user cho một item dựa trên rating của chính user đó cho các item tương tự.
</details>
<details>
