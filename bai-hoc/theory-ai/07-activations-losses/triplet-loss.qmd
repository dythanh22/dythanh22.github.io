...
## Kiểm tra nhanh
<details>
<summary>Ý chính của bài «Triplet Loss» là gì?</summary>
Triplet loss học embedding bằng cách so sánh ba mẫu mỗi lần: * **Anchor (a)**: mẫu tham chiếu * **Positive (p)**: mẫu giống anchor (cùng lớp/identity) * **Negative (n)**: mẫu khác anchor (khác lớp/identity) Mục tiêu: học embedding sao cho anchor gần positive…
</details>
<details>
