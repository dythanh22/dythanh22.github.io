...
## Kiểm tra nhanh
<details>
<summary>Ý chính của bài «Contrastive Loss (Siamese)» là gì?</summary>
Contrastive learning huấn luyện mô hình tạo embedding sao cho: * **Mục giống nhau nằm gần nhau** trong không gian embedding * **Mục khác nhau nằm xa nhau** Khác với phân loại: * Phân loại gán mục vào các nhóm cố định * Contrastive learning học một metric…
</details>
<details>
