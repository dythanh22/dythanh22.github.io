...
## Kiểm tra nhanh
<details>
<summary>Ý chính của bài «Dice Loss» là gì?</summary>
Trong semantic segmentation, mục tiêu là gán lớp cho từng pixel trong ảnh: * Đầu vào: ảnh kích thước $H \times W$ * Đầu ra: mask kích thước $H \times W$ trong đó mỗi pixel có một nhãn lớp Thách thức: mất cân bằng lớp rất nặng.
</details>
<details>
