...
## Kiểm tra nhanh
<details>
<summary>Ý chính của bài «Double Exponential Smoothing» là gì?</summary>
**Double exponential smoothing** (phương pháp tuyến tính của Holt) mở rộng simple exponential smoothing để xử lý dữ liệu có trend.
</details>
<details>
