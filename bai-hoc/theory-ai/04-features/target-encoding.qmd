...
## Kiểm tra nhanh
<details>
<summary>Ý chính của bài «Target Encoding» là gì?</summary>
**Target encoding** (còn gọi là mean encoding hoặc likelihood encoding) là kỹ thuật đổi feature categorical thành giá trị số bằng cách thay mỗi category bằng một thống kê tính từ biến target.
</details>
<details>
