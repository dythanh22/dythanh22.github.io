...
## Kiểm tra nhanh
<details>
<summary>Ý chính của bài «K-Fold Split (chỉ chỉ số)» là gì?</summary>
**K-Fold Cross-Validation** là kỹ thuật resampling dùng để đánh giá mô hình machine learning khi dữ liệu hạn chế.
</details>
<details>
